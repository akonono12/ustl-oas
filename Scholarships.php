   ...
   <div class="container">
        <div class="row">
            <div class="col-md-12"><br><br>
                <h2 id=tables-hover-rows>List of Scholarships</h2>
                <a href="addscho.php"><button type="button" name="add" class="btn btn-success">Add</button></a>
                <div class=bs-example data-example-id=hoverable-table> 
                    <table class="table table-hover"> 
                        ...
                        <tbody>
                            <?php
                                $res = mysqli_query($con,"SELECT a.*, CONCAT(office_name) as office_name FROM scholarships a LEFT JOIN office b ON a.office_id = b.id");
                                    ...
                                    while($row=mysqli_fetch_array($res,MYSQLI_ASSOC)){
                                        echo "
                                            <tr> 
                                                ...
                                                <td> </td>
                                                <td>
                                                    <a href='editscho.php?id=".$row['id']."'><button type='button' class='btn btn-info'>Update</button></a>
                                                    <a href='./modules/delscho.php?id=".$row['id']."'><button type='button' class='btn btn-danger'>Delete</button></a>
                                                </td>
                                            </tr>
                                            ";
                                    }
