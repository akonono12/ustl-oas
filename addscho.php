  ...
  <body>
    ...
    <div class="row">
      <div class="col-md-12">
        <h2>Add</h2>
        <center>
        <form method="post" action="./modules/savescho.php?mode=add">
          <div class="form-group">
            <label for="scho_name">Scholarship Name</label>
            <input type="text" class="form-control" id="scho_name" name="scho_name" placeholder="Scholarship Name" required >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="dept_head">Office</label>
