...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="css/style-upld.css">
  </head>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
           <ul class="nav navbar-nav ml-auto">
            ...
            ?>
              ...
              <li class="active"><a class="nav-link" href="Application.php">Application</a></li>
    ...
    <div class="container">
      <div class="row">
        <?php
          $sql = "SELECT applicants.*, scholarships.name, scholarships.id as s_id FROM applicants, scholarships WHERE applicants.scholarships_id = scholarships.id AND applicants.student_id =".$_SESSION['student_id'];
          //echo $sql;
