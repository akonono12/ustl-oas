   ...
   <div class="container">
        <div class="row">
            <div class="col-md-12"><br><br>
                <h2 id=tables-hover-rows>List of Users</h2>
                <div class=bs-example data-example-id=hoverable-table> 
                    <table class="table table-hover"> 
                        ...
                        <tbody>
                            <?php
                                $res = mysqli_query($con,"SELECT a.*, IF(a.student_id = 0, CONCAT(b.first_name,' ',b.middle_name,' ',b.last_name), CONCAT(c.first_name,' ',c.middle_name,' ',c.last_name)) AS name FROM users a LEFT JOIN employees b ON a.emp_id = b.id LEFT JOIN students c ON a.student_id = c.id");
                                    ...
                                    while($row=mysqli_fetch_array($res,MYSQLI_ASSOC)){
                                        echo "
                                            <tr>
                                                ...
                                                <td>".$row['role']."</td> 
                                                <td>
                                                    <a href='edituser.php?id=".$row['id']."'><button type='button' class='btn btn-info'>Update</button></a>
                                                    <a href='./modules/deluser.php?id=".$row['id']."'><button type='button' class='btn btn-danger'>Delete</button></a>
                                                </td>
                                            </tr>
                                            ";
                                    } 
