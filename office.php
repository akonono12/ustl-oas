   ...
   <div class="container">
        <div class="row">
            <div class="col-md-12"><br><br>
                <h2 id=tables-hover-rows>List of Offices</h2>
                <a href="addoffice.php"><button type="button" name="add" class="btn btn-success">Add</button></a>
                <div class=bs-example data-example-id=hoverable-table> 
                    <table class="table table-hover"> 
                        ...
                        <tbody>
                            <?php
                                $res = mysqli_query($con,"SELECT a.*, CONCAT(first_name,' ',middle_name,' ',last_name) as emp_name FROM office a LEFT JOIN employees b ON a.office_head_id = b.id");
                                    ...
                                    while($row=mysqli_fetch_array($res,MYSQLI_ASSOC)){
                                        echo "
                                            <tr> 
                                                ...
                                                <td>".$row['emp_name']."</td>
                                                <td>
                                                    <a href='editdept.php?id=".$row['id']."'><button type='button' class='btn btn-info'>Update</button></a>
                                                    <a href='./modules/deldept.php?id=".$row['id']."'><button type='button' class='btn btn-danger'>Delete</button></a>
                                                </td>
                                            </tr>
                                            ";
                                    }
