  ...
  <body>
    ...
    <div class="row">
      <div class="col-md-12"><br><br>
        <h2>Edit</h2>
        <center>
        <form method="post" action="modules/saveemp.php?mode=update">
          <?php
            $data = mysqli_query($con,"SELECT a.*, b.office_name FROM employees a JOIN office b ON a.office_id = b.id WHERE a.id = '".$_GET['id']."' LIMIT 1");
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="" name="role" >
              <option value='admin' <?php ($n['role'] == "admin" ? "selected":""); ?> >admin</option>
              <option value='user' <?php ($n['role'] == "user" ? "selected":""); ?> >user</option>
              <option value='admin2' <?php ($n['role'] == "admin2" ? "selected":""); ?> >admin 2</option>
              <option value='admin2' <?php ($n['role'] == "superadmin" ? "selected":""); ?> >superadmin</option>
            </select>
          </div>
