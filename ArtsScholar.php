...
<html lang="en">
  ...
  <body>
    ...
    <br><br>
    <center>
    <img src="pics/Arts.jpg" style="width:800px;height:500px;">
    <h1>Arts Scholarship</h1>
    <p><h3>The scholarship grant covers chorale,dance troupe, theatre, band and string ensemble. <br>
     The scholarship is open to students of all programs.</h3></p>
    <br><br>
    <h1><u>Priveleges</u></h1>
      ...
      <h3><p>a.) One hundred percent (100%) semestral discount on tuition and selected miscellaneous fees for: <br>
                ...
                2.) Artists with a GWA of 80%, with no failing grade in any subject<br>
     ...
     b.) Seventy-five percent (75%) semestral discount on tuition and selected miscellaneous fees for: <br>
        1.) Artists with a GWA of 80%, with no failing grade in any subject<br>
