   ...
   <div class="container"> 
        <div class="row">
            <div class="col-md-12"><br><br>
                <h2 id=tables-hover-rows>List of Students</h2>
                <a href="addstud.php"><button type="button" name="add" class="btn btn-success">Add</button></a>
                                    ...
                                    while($row=mysqli_fetch_array($res,MYSQLI_ASSOC)){
                                        echo "
                                            <tr> 
                                                ...
                                                <td>".$row['last_name']."</td> 
                                                <td>
                                                    <a href='editstud.php?id=".$row['id']."'><button type='button' class='btn btn-info'>Update</button></a>
                                                    <a href='./modules/delstud.php?id=".$row['id']."'><button type='button' class='btn btn-danger'>Delete</button></a>
                                                </td>
                                            </tr>
                                            ";
                                    }
